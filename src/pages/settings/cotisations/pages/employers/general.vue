<script setup>
import employersForm from "@/views/cotisations/forms/employers.vue"
...
snackbarText.value = "La cotisation a bien été enregistrée";
      ...
      <VRow>
        <VCol cols="12" md="12">
          <VCard>
            ...
            <VCardText>
              <employers-form :form="form" @save="handleSave" />
            </VCardText>
          </VCard>
        </VCol>
      </VRow>
