...
const cotisationName= route.query.name

const removeCotisation = function() {
  isSpinnerVisible.value = true;

  setTimeout(() => {
    alertText.value = `La cotisation patronale ${cotisationName} a bien été supprimée`;
    isSpinnerVisible.value = false;
    isAlertVisible.value = true;
    // router.push('/settings/cotisations/employers')
  }, 2000);
};
</script>
